  ...
  return (
    ...
    >
      <div className='flex h-[18px] w-[220px] items-center justify-between md:h-[19px] md:w-[206px] xl:h-[19px] xl:w-[292px] '>
        <div className='gap-3 flex h-[17px] w-[88px] items-center justify-between md:h-[19px] md:w-[100px] xl:h-[19px] xl:w-[108px]'>
		  <FaCircle className='h-[8px] w-[8px]' style={{ color: color as string }} />
		  <div className='flex font-semibold text-sm md:text-base xl:text-base h-[17px] w-[68px] items-center justify-between md:h-[19px] md:w-[80px] xl:h-[19px] xl:w-[84px]'>
			{title}
			{createdByMe && <FaCrown className='text-yellow-500' />}
		  </div>
        </div>
